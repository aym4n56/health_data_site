...
data = data.drop(columns=['Blood Pressure', 'test', 'High_Blood_Pressure', 'low_Blood_Pressure', 'Stress Level'])
...
print(f"Mean Squared Error for predicting Sleep Quality: {mse:.2f}")

# Plotting feature importance
plt.figure(figsize=(12, 10))
sns.heatmap(X.corr(), annot=True, cmap='coolwarm', fmt='.2f')
plt.title('Feature Correlation Matrix (Sleep Quality Prediction)')
plt.show()

#mse for predicting sleep quality is 0.22
